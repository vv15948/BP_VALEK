function plot_voxel_grid(voxel_grid,range, voxel_size,joint_angles,robot, path,path_extra,traveled_path)
...
nexttile
    ...
    if ~isempty(path_extra)
        plot3(path_extra(:,1), path_extra(:,2), path_extra(:,3), 'g-', 'LineWidth', 2); % Tyrkysová trajektorie
    end
